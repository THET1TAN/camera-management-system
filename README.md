...
if that environment variable is set. A source snapshot such as `~v0.2.9` can also
...
inside `~v0.2.9`, keep the sibling `~v0.2.8` folder available.
...
| `~v0.2.9/` | Source snapshot matching the current release |
