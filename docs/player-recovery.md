...
Released as **v0.2.9**, based on `main` **8c8a9d7**, after v0.2.8 / PR #11.
Joël explicitly authorized merging PR #12 and completing issue #9 on 2026-09-18.
...
RTSP/GPU rendering checks are reported separately. Joël reported recovery in a
physical-camera test; the missing-bitrate incident still needs a targeted repeat.
...
To return to v0.2.8, close the Viewer and its children and restore the sources
from revision `8c8a9d7` (or use its preserved `~v0.2.8` source
