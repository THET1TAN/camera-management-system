...
this PR and the local installation concern Python sources. Joël explicitly
authorized merging PR #12 as v0.2.9 and completing issue #9 on 2026-09-18. This
approval does not convert the unperformed checks above into validated results.
